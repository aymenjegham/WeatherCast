...
public class AppNotification extends Application {
    ...
    private void createNotificationchannels() {
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            ...
            channel1.setDescription("This is channel one for high propriety notifications");

            NotificationChannel channel2 = new NotificationChannel(CHANNEL_2_ID,
                    "Channel 2",
                    NotificationManager.IMPORTANCE_LOW);
            channel1.setDescription("This is channel one for low propriety notifications");
